...
echo "========================================================"
echo "ComfyUI Installation Script for RunPod"
echo "========================================================"
echo ""
echo "IMPORTANT: This script will:"
echo "  - Install PyTorch 2.9.1 with CUDA 13.0"
echo "  - Install ComfyUI and custom nodes"
echo ""
echo "========================================================"
echo "Optional Custom Nodes / Bundles"
echo "========================================================"
echo ""
